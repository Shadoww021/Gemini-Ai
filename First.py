...
# x =  '{ "name":"John", "age":30, "city":"New York", "isTeacher":true, "isMarried":false, "lname":null}'
# print(x)
# y = json.loads(x)
# print(y['name'])
...
# j100    pip
# import cowsay
# cowsay.cow("Hello Narges")
# ------------------------------------
# j103     visual envierment2
# import camelcase
# ---------------------------------
# j105   Exception handeling(some exception error)
# print(55 / 0)
...
# from json import ali

# print(x)
# -------------------------------------------------------
# j106      Exception handeling
# try:
#     print('hi')
#     print(x)
#     print('hi')
...
# if a < 5:
#     raise Exception('we have exception error')

# if a < 5:
#     raise NameError('we have exception error')


# try:
#     print(x)
# except:
#     raise NameError('we have name error hahahahah mother fucker')
# -----------------------------------------------------------------------------------------------Start Python Proffetional
# j108
